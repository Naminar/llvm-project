...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  case AscendGeneric:  return "AscendGeneric";
...
Triple::ArchType Triple::getArchTypeForLLVMName(StringRef Name) {
  ...
  return StringSwitch<Triple::ArchType>(Name)
    ...
    .Case("lanai", lanai)
    .Case("shave", shave)
    .Case("AscendGeneric", AscendGeneric)
    .Case("wasm32", wasm32)
    .Case("wasm64", wasm64)
...
static Triple::ArchType parseArch(StringRef ArchName) {
  auto AT =
      StringSwitch<Triple::ArchType>(ArchName)
          ...
          .Case("AscendGeneric", Triple::AscendGeneric)
          .Case("ve", Triple::ve)
...
unsigned Triple::getArchPointerBitWidth(llvm::Triple::ArchType Arch) {
  ...
  case llvm::Triple::AscendGeneric:
